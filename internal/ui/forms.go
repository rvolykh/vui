...
func NewFormsManager(config *config.Config, vaultMgr *vault.Manager, logger *logrus.Logger) *FormsManager {
	return &FormsManager{
		config:   config,
		vaultMgr: vaultMgr,
		logger:   logger,
